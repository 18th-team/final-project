    ...
    function connect() {
        ...
        stompClient.connect({}, function (frame) {
            ...
            setTimeout(function () {
                ...
                stompClient.send("/app/refreshChatRooms", {}, "");
            }, 500);
        }, function (error) {
    ...
    function renderChatList(chatRooms) {
        ...
        chatRooms.forEach(chat => {
            console.log('Processing chat:', chat); // 각 채팅방 로그
            ...
            item.innerHTML = `
                ...
                <div class="chat-content">
                    ...
                    <p class="chat-preview">${isRequest ? (chat.requestReason || '없음') : (chat.lastMessage || '대화가 없습니다.')}</p>
                    ${isRequest ? `
